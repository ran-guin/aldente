...
--
-- Table structure for table `Study_Attribute`
--

DROP TABLE IF EXISTS `Study_Attribute`;
CREATE TABLE `Study_Attribute` (
  `FK_Study__ID` int(11) NOT NULL DEFAULT '0',
  ...
  UNIQUE KEY `study_attribute` (`FK_Study__ID`,`FK_Attribute__ID`),
  KEY `FK_Study__ID` (`FK_Study__ID`),
