...
--
-- Table structure for table `Invoiceable_Analysis`
--

DROP TABLE IF EXISTS `Invoiceable_Analysis`;
CREATE TABLE `Invoiceable_Analysis` (
  ...
  `FKParent_Invoiceable_Analysis__ID` int(11) DEFAULT NULL,
  `Indexed` int(11) DEFAULT NULL,
  `Invoiceable_Analysis_Comments` text,
  ...
  KEY `FK_Analysis_Step__ID` (`FK_Analysis_Step__ID`),
  KEY `FK_Invoice_Analysis_Step__ID` (`FK_Invoice_Analysis_Step__ID`),
  KEY `FK_Invoice__ID` (`FK_Invoice__ID`),
  KEY `FK_Work_Request__ID` (`FK_Work_Request__ID`),
  KEY `FKParent_Invoiceable_Analysis__ID` (`FKParent_Invoiceable_Analysis__ID`)
