...
#######################
    ...
    my $page = SDB::Form::start_SDB_form( -dbc => $dbc, -name => 'help' );
    ...
    my $Search = SDB::SDB_Defaults::search_fields();
    ...
    my $matches = SDB::Tools::Search_Database( -dbc => $dbc, -input_string => $string, -search => $Search, -table => $table );
