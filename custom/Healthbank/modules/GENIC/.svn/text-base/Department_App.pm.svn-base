...
#
package Healthbank::GENIC::Department_App;
...
use Healthbank::GENIC::Department;
##############################
# global_vars                #
##############################
...
######################
    ...
    return Healthbank::Views::view_discrepencies($dbc);
...
##################
   ...
   my $home_form = Healthbank::GENIC::Department_Views::home_page($dbc); 
