package Healthbank::BCG_Mobile::Department;
...
my @icons_list = qw( Home BCG_Help BCG_Summary Contacts );
...
##################
    ...
    # BCG_Mobile permissions for searches
    if ( grep( /BCG_Mobile/, @{ $Access{BCG_Mobile} } ) ) {
    ...
    if ( grep( /Admin/, @{ $Access{'BCG_Mobile'} } ) ) {
...
#######################
    ...
    $images{BCG_Summary}{icon} = "Daily_Planner.png";
    $images{BCG_Summary}{url}  = "cgi_application=Healthbank::BCG_Mobile::Statistics_App";
    $images{BCG_Summary}{name} = "BCG";
    $images{BCG_Summary}{tip}  = "Public Summary of BC Generations Data";

    $images{Home}{icon} = "home.png";
    $images{Home}{url}  = "cgi_application=Healthbank::BCG_Mobile::Department_App";
    $images{Home}{name} = "BCG";
    $images{Home}{tip}  = "Home page for BCG_Mobile";
