package Healthbank::BC_Generations::Summary_Views;

use base Healthbank::Summary_Views;
...
##########################
    ...
    my $page = subsection_heading('Breakdown Summary by Subject');
...
########################
    ...
    my $tables = "Plate, Plate as Parent, Sample_Type, Plate_Sample, Sample, Source, Original_Source, Patient ";  
