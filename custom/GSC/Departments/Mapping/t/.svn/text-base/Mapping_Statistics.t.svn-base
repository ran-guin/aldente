...
############################################################
use_ok("Mapping::Mapping_Statistics");

if ( !$method || $method =~ /\bset_general_options\b/ ) {
    can_ok("Mapping::Mapping_Statistics", 'set_general_options');
    {
...
if ( !$method || $method =~ /\bset_input_options\b/ ) {
    can_ok("Mapping::Mapping_Statistics", 'set_input_options');
    {
...
if ( !$method || $method =~ /\bset_output_options\b/ ) {
    can_ok("Mapping::Mapping_Statistics", 'set_output_options');
    {
...
ok( 1 ,'Completed Mapping_Statistics test');
