...
#
###################################################################################################################################
package BioInformatics::Summary_App;
...
###########################
    ...
    $form .= "We are at BioInformatics summary";
    $form .= $q->hidden( -name => 'cgi_application', -value => 'BioInformatics::Summary_App', -force => 1 );
...
###########################
    ...
    $form .= Views::sub_Heading( "Summary", -1 );
    $form .= "Here's the display for BioInformatics";
