...
#
package BioInformatics::Department_App;
...
##################
    ...
    my $search_create_box = $self->View->search_create_box( -search => \@searches, -create => \@creates, -convert => \@conversions, -custom_search => $custom );
}
