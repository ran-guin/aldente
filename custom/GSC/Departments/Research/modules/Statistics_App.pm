###################################################################################################################################
# Research::Statistics_App.pm
#
#
#
#
###################################################################################################################################
package Research::Statistics_App;
...
###########################
    ...
    $form .= "We are at Research stats";
    $form .= $q->hidden( -name => 'cgi_application', -value => 'Research::Statistics_App', -force => 1 );
