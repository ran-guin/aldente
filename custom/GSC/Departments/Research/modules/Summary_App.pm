...
###########################
    ...
    $form .= "We are at Research summary";
    $form .= $q->hidden( -name => 'cgi_application', -value => 'Research::Summary_App', -force => 1 );
...
###########################
    ...
    $form .= Views::sub_Heading( "Summary", -1 );
    $form .= "Here's the display for Research";
