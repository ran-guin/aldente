...
############################################################
use_ok("Research::Statistics_App");

if ( !$method || $method =~ /\bsetup\b/ ) {
    can_ok("Research::Statistics_App", 'setup');
    {
...
if ( !$method || $method =~ /\bstat_page\b/ ) {
    can_ok("Research::Statistics_App", 'stat_page');
    {
...
if ( !$method || $method =~ /\bdisplay_stats\b/ ) {
    can_ok("Research::Statistics_App", 'display_stats');
    {
