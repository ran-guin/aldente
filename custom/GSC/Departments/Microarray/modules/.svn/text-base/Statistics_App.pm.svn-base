###################################################################################################################################
# Micorarray::Statistics.pm
#
#
#
#
###################################################################################################################################
package Microarray::Statistics_App;
...
###########################
    ...
    my $title = 'Genechip Statistics';
    my $class = "Microarray::Genechip_Statistics";
    eval "require $class";
    Message($@) if $@;
    ...
    my $webapp = $application->new(
        PARAMS => {
            dbc           => $dbc,
            'Source Call' => 'Microarray::Statistics_App',
            Quiet         => 'quiet',
            Object        => $view
        }
    );
