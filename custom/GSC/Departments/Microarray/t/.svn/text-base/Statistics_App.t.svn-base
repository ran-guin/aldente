...
############################################################
use_ok("Microarray::Statistics_App");

if ( !$method || $method =~ /\bsetup\b/ ) {
    can_ok("Microarray::Statistics_App", 'setup');
    {
...
if ( !$method || $method =~ /\bsearch_page\b/ ) {
    can_ok("Microarray::Statistics_App", 'search_page');
    {
...
if ( !$method || $method =~ /\bdisplay_Stats\b/ ) {
    can_ok("Microarray::Statistics_App", 'display_Stats');
    {
