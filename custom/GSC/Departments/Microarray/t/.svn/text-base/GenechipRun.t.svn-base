...
sub self {
    ...
    return new Microarray::GenechipRun(%args);

}

############################################################
use_ok("Microarray::GenechipRun");

if ( !$method || $method =~ /\bnew\b/ ) {
    can_ok("Microarray::GenechipRun", 'new');
    {
...
if ( !$method || $method =~ /\bload_Object\b/ ) {
    can_ok("Microarray::GenechipRun", 'load_Object');
    {
...
if ( !$method || $method =~ /\bhome_page\b/ ) {
    can_ok("Microarray::GenechipRun", 'home_page');
    {
...
if ( !$method || $method =~ /\brequest_broker\b/ ) {
    can_ok("Microarray::GenechipRun", 'request_broker');
    {
...
if ( !$method || $method =~ /\bdisplay_general\b/ ) {
    can_ok("Microarray::GenechipRun", 'display_general');
    {
...
if ( !$method || $method =~ /\bdisplay_stats\b/ ) {
    can_ok("Microarray::GenechipRun", 'display_stats');
    {
...
if ( !$method || $method =~ /\bdisplay_mapping_stats\b/ ) {
    can_ok("Microarray::GenechipRun", 'display_mapping_stats');
    {
...
if ( !$method || $method =~ /\bdisplay_expression_stats\b/ ) {
    can_ok("Microarray::GenechipRun", 'display_expression_stats');
    {
...
if ( !$method || $method =~ /\bdisplay_actions\b/ ) {
    can_ok("Microarray::GenechipRun", 'display_actions');
    {
...
if ( !$method || $method =~ /\bdisplay_qc_plot\b/ ) {
    can_ok("Microarray::GenechipRun", 'display_qc_plot');
    {
...
if ( !$method || $method =~ /\b_display_samplesheet\b/ ) {
    can_ok("Microarray::GenechipRun", '_display_samplesheet');
    {
