...
############################################################
use_ok("Microarray::Summary_App");

if ( !$method || $method =~ /\bsetup\b/ ) {
    can_ok("Microarray::Summary_App", 'setup');
    {
...
if ( !$method || $method =~ /\bsearch_page\b/ ) {
    can_ok("Microarray::Summary_App", 'search_page');
    {
...
if ( !$method || $method =~ /\bdisplay_Summary\b/ ) {
    can_ok("Microarray::Summary_App", 'display_Summary');
    {
