...
##################
    ...
    return Departments::QC::Department_Views::home_page( -dbc => $dbc );
}
...
##################
    ...
    my ( $search_ref, $creates_ref, $conversion_ref, $custom ) = QC::Department::get_searches_and_creates( -access => \%Access );
