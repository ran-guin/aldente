...
package Lib_Construction::Genechip_Summary;
...
#
  ...
  $self->{config}{API_path}    = 'Lib_Construction'; ## path to the API module
...
#
  ...
  if(scalar @ids > 0){
	...
	$html->Set_Row([$snp, @{$snps_hash{$snp}{data}}]);
      ...
      my $genechip_run = Lib_Construction::GenechipRun->new(-dbc=>$dbc);
