###################################################################################################################################
# Lib_Construction::Summary_App.pm
#
#
#
#
###################################################################################################################################
package Lib_Construction::Summary_App;
...
###########################
    ...
    $form .= "We are at Library Construction summary";
    $form .= $q->hidden( -name => 'cgi_application', -value => 'Lib_Construction::Summary_App', -force => 1 );
