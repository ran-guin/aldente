...
############################################################
use_ok("Lib_Construction::Statistics");

if ( !$method || $method =~ /\bset_general_options\b/ ) {
    can_ok("Lib_Construction::Statistics", 'set_general_options');
    {
...
if ( !$method || $method =~ /\bset_input_options\b/ ) {
    can_ok("Lib_Construction::Statistics", 'set_input_options');
    {
...
if ( !$method || $method =~ /\bset_output_options\b/ ) {
    can_ok("Lib_Construction::Statistics", 'set_output_options');
    {
