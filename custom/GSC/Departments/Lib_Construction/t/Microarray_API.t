...
############################################################
use_ok("Lib_Construction::Microarray_API");

if ( !$method || $method =~ /\bget_genechiprun_data\b/ ) {
    can_ok("Lib_Construction::Microarray_API", 'get_genechiprun_data');
    {
...
if ( !$method || $method =~ /\bget_genechiprun_summary\b/ ) {
    can_ok("Lib_Construction::Microarray_API", 'get_genechiprun_summary');
    {
...
if ( !$method || $method =~ /\bget_spectrun_data\b/ ) {
    can_ok("Lib_Construction::Microarray_API", 'get_spectrun_data');
    {
...
if ( !$method || $method =~ /\bget_spectread_data\b/ ) {
    can_ok("Lib_Construction::Microarray_API", 'get_spectread_data');
    {
...
if ( !$method || $method =~ /\bget_bioanalyzerrun_data\b/ ) {
    can_ok("Lib_Construction::Microarray_API", 'get_bioanalyzerrun_data');
    {
...
if ( !$method || $method =~ /\bget_bioanalyzerread_data\b/ ) {
    can_ok("Lib_Construction::Microarray_API", 'get_bioanalyzerread_data');
    {
