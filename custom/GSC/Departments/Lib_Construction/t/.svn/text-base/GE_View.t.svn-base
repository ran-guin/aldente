...
############################################################
use_ok("Lib_Construction::GE_View");

if ( !$method || $method =~ /\bprep_status\b/ ) {
    can_ok("Lib_Construction::GE_View", 'prep_status');
    {
...
if ( !$method || $method =~ /\bTrack_Plates\b/ ) {
    can_ok("Lib_Construction::GE_View", 'Track_Plates');
    {
...
if ( !$method || $method =~ /\bshow_Prepped_Plates\b/ ) {
    can_ok("Lib_Construction::GE_View", 'show_Prepped_Plates');
    {
