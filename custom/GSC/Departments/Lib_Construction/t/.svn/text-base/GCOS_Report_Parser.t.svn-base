...
############################################################
use_ok("Lib_Construction::GCOS_Report_Parser");

if ( !$method || $method =~ /\bresolve_report\b/ ) {
    can_ok("Lib_Construction::GCOS_Report_Parser", 'resolve_report');
    {
...
if ( !$method || $method =~ /\brewrite_report\b/ ) {
    can_ok("Lib_Construction::GCOS_Report_Parser", 'rewrite_report');
    {
...
if ( !$method || $method =~ /\bprocess_report_file\b/ ) {
    can_ok("Lib_Construction::GCOS_Report_Parser", 'process_report_file');
    {
...
if ( !$method || $method =~ /\blink_report\b/ ) {
    can_ok("Lib_Construction::GCOS_Report_Parser", 'link_report');
    {
...
if ( !$method || $method =~ /\bread_report_file\b/ ) {
    can_ok("Lib_Construction::GCOS_Report_Parser", 'read_report_file');
    {
...
if ( !$method || $method =~ /\bread_expression_file\b/ ) {
    can_ok("Lib_Construction::GCOS_Report_Parser", 'read_expression_file');
    {
...
if ( !$method || $method =~ /\bread_mapping_file\b/ ) {
    can_ok("Lib_Construction::GCOS_Report_Parser", 'read_mapping_file');
    {
...
if ( !$method || $method =~ /\b_read_csv_portion\b/ ) {
    can_ok("Lib_Construction::GCOS_Report_Parser", '_read_csv_portion');
    {
...
if ( !$method || $method =~ /\b_map_to_field\b/ ) {
    can_ok("Lib_Construction::GCOS_Report_Parser", '_map_to_field');
    {
...
if ( !$method || $method =~ /\b_find_project_library\b/ ) {
    can_ok("Lib_Construction::GCOS_Report_Parser", '_find_project_library');
    {
