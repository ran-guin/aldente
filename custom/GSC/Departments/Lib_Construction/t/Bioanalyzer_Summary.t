...
############################################################
use_ok("Lib_Construction::Bioanalyzer_Summary");

if ( !$method || $method =~ /\bset_general_options\b/ ) {
    can_ok("Lib_Construction::Bioanalyzer_Summary", 'set_general_options');
    {
...
if ( !$method || $method =~ /\bset_input_options\b/ ) {
    can_ok("Lib_Construction::Bioanalyzer_Summary", 'set_input_options');
    {
...
if ( !$method || $method =~ /\bset_output_options\b/ ) {
    can_ok("Lib_Construction::Bioanalyzer_Summary", 'set_output_options');
    {
...
if ( !$method || $method =~ /\bdo_actions\b/ ) {
    can_ok("Lib_Construction::Bioanalyzer_Summary", 'do_actions');
    {
