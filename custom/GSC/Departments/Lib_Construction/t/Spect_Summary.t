...
sub self {
    ...
    return new Lib_Construction::Spect_Summary(%args);

}

############################################################
use_ok("Lib_Construction::Spect_Summary");

if ( !$method || $method =~ /\bnew\b/ ) {
    can_ok("Lib_Construction::Spect_Summary", 'new');
    {
...
if ( !$method || $method =~ /\bpreset_input_fields\b/ ) {
    can_ok("Lib_Construction::Spect_Summary", 'preset_input_fields');
    {
...
if ( !$method || $method =~ /\bconfigure\b/ ) {
    can_ok("Lib_Construction::Spect_Summary", 'configure');
    {
...
if ( !$method || $method =~ /\bget_default_inputs\b/ ) {
    can_ok("Lib_Construction::Spect_Summary", 'get_default_inputs');
    {
...
if ( !$method || $method =~ /\bset_default_inputs\b/ ) {
    can_ok("Lib_Construction::Spect_Summary", 'set_default_inputs');
    {
...
if ( !$method || $method =~ /\bpreset_output_fields\b/ ) {
    can_ok("Lib_Construction::Spect_Summary", 'preset_output_fields');
    {
