...
#
package Cap_Seq::Department_App;
...
use base alDente::Department_App;
...
use Cap_Seq::Department;
use Cap_Seq::Department_Views;
...
##################
    ...
    return Departments::Cap_Seq::Department_Views::home_page( -dbc => $dbc );
}
...
##################
    ...
    my ( $search_ref, $creates_ref, $conversion_ref, $custom ) = Cap_Seq::Department::get_searches_and_creates( -access => \%Access );
