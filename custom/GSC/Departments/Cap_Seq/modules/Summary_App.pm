###################################################################################################################################
# Cap_Seq::Summary_App.pm
#
#
#
#
###################################################################################################################################
package Cap_Seq::Summary_App;
...
###########################
    ...
    $form .= "We are at Cap_Seq summary";
    $form .= $q->hidden( -name => 'cgi_application', -value => 'Cap_Seq::Summary_App', -force => 1 );
...
###########################
    ...
    $form .= Views::sub_Heading( "Summary", -1 );
    $form .= "Here's the display for Cap_Seq";
