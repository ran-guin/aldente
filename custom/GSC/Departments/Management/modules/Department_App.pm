...
#
package Management::Department_App;
...
use Management::Department;
use Management::Department_Views;
...
##################
    ...
    my $search_create_box = alDente::Department::search_create_box( -search => \@searches, -create => \@creates, -convert => \@conversions, -custom_search => $custom );
}
