###################################################################################################################################
# Management::Statistics_App.pm
#
#
#
#
###################################################################################################################################
package Management::Statistics_App;
...
###########################
	...
	$form .= "We are at Management stats";
	$form .= $q-> hidden (-name => 'cgi_application', -value => 'Management::Statistics_App' ,-force=>1);	
