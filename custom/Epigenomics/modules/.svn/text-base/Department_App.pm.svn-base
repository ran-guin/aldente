...
##################
#
# This module is the App for Epigenomics Department.
#
package Epigenomics::Department_App;
...
##################
    ...
    return Departments::Epigenomics::Department_Views::home_page( -dbc => $dbc );
}
...
##################
    ...
    my ( $search_ref, $creates_ref, $conversion_ref, $custom ) = Epigenomics::Department::get_searches_and_creates( -access => \%Access );
    my @searches    = @$search_ref;
    my @creates     = @$creates_ref;
    my @conversions = @$conversion_ref;

    my $search_create_box = alDente::Department::search_create_box( -dbc => $dbc, -search => \@searches, -create => \@creates, -convert => \@conversions, -custom_search => $custom );
}
