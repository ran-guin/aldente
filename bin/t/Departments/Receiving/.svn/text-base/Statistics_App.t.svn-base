...
############################################################
use_ok("Receiving::Statistics_App");

if ( !$method || $method =~ /\bsetup\b/ ) {
    can_ok("Receiving::Statistics_App", 'setup');
    {
...
if ( !$method || $method =~ /\bstat_page\b/ ) {
    can_ok("Receiving::Statistics_App", 'stat_page');
    {
...
if ( !$method || $method =~ /\bdisplay_stats\b/ ) {
    can_ok("Receiving::Statistics_App", 'display_stats');
    {
...
if ( !$method || $method =~ /\badvanced_search\b/ ) {
    can_ok("Receiving::Statistics_App", 'advanced_search');
    {
...
if ( !$method || $method =~ /\breturn_form\b/ ) {
    can_ok("Receiving::Statistics_App", 'return_form');
    {
