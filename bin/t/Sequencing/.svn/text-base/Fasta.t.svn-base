...
############################################################
use_ok("Sequencing::Fasta");

if ( !$method || $method=~/\bget_library_sequences\b/ ) {
    can_ok("Sequencing::Fasta", 'get_library_sequences');
    {
...
if ( !$method || $method=~/\bget_run_sequences\b/ ) {
    can_ok("Sequencing::Fasta", 'get_run_sequences');
    {
...
if ( !$method || $method=~/\blibrary_phred_passes\b/ ) {
    can_ok("Sequencing::Fasta", 'library_phred_passes');
    {
...
if ( !$method || $method=~/\bsequence_phred_passes\b/ ) {
    can_ok("Sequencing::Fasta", 'sequence_phred_passes');
    {
...
if ( !$method || $method=~/\bthreshold_phred_scores\b/ ) {
    can_ok("Sequencing::Fasta", 'threshold_phred_scores');
    {
...
if ( !$method || $method=~/\bget_good_sequence\b/ ) {
    can_ok("Sequencing::Fasta", 'get_good_sequence');
    {
...
if ( !$method || $method=~/\bget_sequences\b/ ) {
    can_ok("Sequencing::Fasta", 'get_sequences');
    {
...
if ( !$method || $method=~/\bfix_output\b/ ) {
    can_ok("Sequencing::Fasta", 'fix_output');
    {
