    ...
    Chosen.prototype.search_results_mouseup = function(evt) {
      ...
      if (this.holding_shift) {
        if (this.selected_elements.length < 1) {
          ...
          selected = null;
          direction = target.previous('.first-selected') ? 'back' : 'forward';
          if (target === this.selected_elements[0]) {
            return false;
          }
          if (direction === "back") {
            selected = target.previousSiblings().collect(function(t) {
              if (t.previous(".first-selected") && !t.hasClassName("result-selected") || t.hasClassName("first-selected")) {
                return t;
              } else {
                return false;
              }
            ...
            selected = target.nextSiblings().collect(function(t) {
              if (t.next(".first-selected") && !t.hasClassName("result-selected") || t.hasClassName("first-selected")) {
                return t;
              } else {
                return false;
              }
          ...
          selected.each(function(elem) {
            _this.result_highlight = elem;
            return _this.result_select(evt);
          });
          this.selected_elements[0].removeClassName("first-selected selected-result");
          this.selected_elements = [];
          this.holding_shift = false;
          selected = false;
          return this.search_field.focus();
