###################################################################################################################################
# Template::Run_Summary.pm
#
#
#
#
###################################################################################################################################
package Template::Run_Summary;
...
##############################
  ...
  $self->{config}{API_module }  = 'Template_API';
  $self->{config}{API_path   }  = 'Template';
  $self->{config}{API_scope  }  = 'Template_Run';   # use get_Template_run_xxx
...
#################################
    ...
    $self->{config}{output_function} = {
        'full_run_path' => "get_Template_summary_html",
