...
##################
#
# This module is a template Statistics App, one will want to customize it according to the needs of the department
#
package <package>::Statistics_App;
...
###############
   ...
   my $home_form = start_custom_form( -name => 'Samples', -parameters => {&Set_Parameters} ); 
   $home_form .= Views::Heading ("Samples");
...
##################
    ...
    my @tables = qw(Source);
    my @display_fields = qw(External_Identifier Received_Date Source_Type);
    my @conditions;    
